...
const post = createPost({
  ...
  description: "YOLO Object Detection Explained for Beginners — a detailed guide by Mohammad Ali Nayeem, Software Engineering student at DIU and founder of Bornosoft. Real lessons from building projects in Bangladesh.",
  category: "YOLO",
  tags: ["YOLO","Computer Vision","AI"],
  keywords: ["YOLO Object Detection Explained for Beginners","Mohammad Ali Nayeem","Bornosoft","Bangladesh","YOLO"],
  publishedAt: "2025-02-05",
  updatedAt: "2025-06-01",
  featured: false,
  popular: true,
  coverImageAlt: "YOLO Object Detection Explained for Beginners - cover image by Mohammad Ali Nayeem",
  relatedSlugs: [],
  faqs: [
  {
  ...
  content: `<p>This article is part of my engineering journal at kazinayeem.site. I'm Mohammad Ali Nayeem, a Software Engineering student at Daffodil International University and founder of Bornosoft. Here I share practical lessons about yolo object detection explained for beginners—not textbook theory, but what actually worked (and failed) in my projects.</p>

<h2>Background & Motivation</h2>

<p>When I started exploring yolo, resources were either too shallow or assumed years of experience. I wrote this guide for students and junior developers in Bangladesh who need a clear path from zero to confident.</p>
...
<pre><code class="language-bash"># Example workflow snippet
 ...
 git commit -m "feat: progress on YOLO Object Detection Explained for Beginners"</code></pre>
...
<p>YOLO Object Detection Explained for Beginners is a living topic—I will update this article as I learn more. If you are a student developer in Bangladesh building with YOLO, connect with me on LinkedIn or explore more articles on kazinayeem.site. Keep building in public.</p>`,
});
