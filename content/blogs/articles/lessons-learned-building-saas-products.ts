...
const post = createPost({
  ...
  title: "Lessons Learned While Building SaaS Products",
  seoTitle: "Lessons Learned While Building SaaS Products | Mohammad Ali Nayeem",
  subtitle: "Practical insights from Mohammad Ali Nayeem, founder of Bornosoft",
  description: "Lessons Learned While Building SaaS Products — a detailed guide by Mohammad Ali Nayeem, Software Engineering student at DIU and founder of Bornosoft. Real lessons from building projects in Bangladesh.",
  category: "Software Engineering",
  tags: ["SaaS","Startup","Bornosoft"],
  keywords: ["Lessons Learned While Building SaaS Products","Mohammad Ali Nayeem","Bornosoft","Bangladesh","Software Engineering"],
  publishedAt: "2025-01-05",
  updatedAt: "2025-06-01",
  featured: false,
  popular: true,
  coverImageAlt: "Lessons Learned While Building SaaS Products - cover image by Mohammad Ali Nayeem",
  relatedSlugs: [],
  faqs: [
  {
  ...
  content: `<p>This article is part of my engineering journal at kazinayeem.site. I'm Mohammad Ali Nayeem, a Software Engineering student at Daffodil International University and founder of Bornosoft. Here I share practical lessons about lessons learned while building saas products—not textbook theory, but what actually worked (and failed) in my projects.</p>

<h2>Background & Motivation</h2>

<p>When I started exploring software engineering, resources were either too shallow or assumed years of experience. I wrote this guide for students and junior developers in Bangladesh who need a clear path from zero to confident.</p>
...
<pre><code class="language-bash"># Example workflow snippet
 ...
 git commit -m "feat: progress on Lessons Learned While Building SaaS Products"</code></pre>
...
<p>Lessons Learned While Building SaaS Products is a living topic—I will update this article as I learn more. If you are a student developer in Bangladesh building with Software Engineering, connect with me on LinkedIn or explore more articles on kazinayeem.site. Keep building in public.</p>`,
});
