...
const post = createPost({
  ...
  title: "My First CI/CD Pipeline Using GitHub Actions",
  seoTitle: "My First CI/CD Pipeline Using GitHub Actions | Mohammad Ali Nayeem",
  subtitle: "Practical insights from Mohammad Ali Nayeem, founder of Bornosoft",
  description: "My First CI/CD Pipeline Using GitHub Actions — a detailed guide by Mohammad Ali Nayeem, Software Engineering student at DIU and founder of Bornosoft. Real lessons from building projects in Bangladesh.",
  category: "GitHub Actions",
  tags: ["CI/CD","GitHub","DevOps"],
  keywords: ["My First CI/CD Pipeline Using GitHub Actions","Mohammad Ali Nayeem","Bornosoft","Bangladesh","GitHub Actions"],
  publishedAt: "2024-10-12",
  updatedAt: "2025-06-01",
  featured: true,
  popular: true,
  coverImageAlt: "My First CI/CD Pipeline Using GitHub Actions - cover image by Mohammad Ali Nayeem",
  relatedSlugs: [],
  faqs: [
  {
  ...
  content: `<p>This article is part of my engineering journal at kazinayeem.site. I'm Mohammad Ali Nayeem, a Software Engineering student at Daffodil International University and founder of Bornosoft. Here I share practical lessons about my first ci/cd pipeline using github actions—not textbook theory, but what actually worked (and failed) in my projects.</p>
...
<pre><code class="language-bash"># Example workflow snippet
 ...
 git commit -m "feat: progress on My First CI/CD Pipeline Using GitHub Actions"</code></pre>
...
<p>My First CI/CD Pipeline Using GitHub Actions is a living topic—I will update this article as I learn more. If you are a student developer in Bangladesh building with GitHub Actions, connect with me on LinkedIn or explore more articles on kazinayeem.site. Keep building in public.</p>`,
});
