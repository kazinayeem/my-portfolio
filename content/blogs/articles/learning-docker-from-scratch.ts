...
const post = createPost({
  ...
  description: "Learning Docker from Scratch — a detailed guide by Mohammad Ali Nayeem, Software Engineering student at DIU and founder of Bornosoft. Real lessons from building projects in Bangladesh.",
  category: "Docker",
  tags: ["Docker","Containers","Tutorial"],
  keywords: ["Learning Docker from Scratch","Mohammad Ali Nayeem","Bornosoft","Bangladesh","Docker"],
  publishedAt: "2024-11-18",
  updatedAt: "2025-06-01",
  featured: false,
  popular: true,
  coverImageAlt: "Learning Docker from Scratch - cover image by Mohammad Ali Nayeem",
  relatedSlugs: [],
  faqs: [
  {
  ...
  content: `<p>This article is part of my engineering journal at kazinayeem.site. I'm Mohammad Ali Nayeem, a Software Engineering student at Daffodil International University and founder of Bornosoft. Here I share practical lessons about learning docker from scratch—not textbook theory, but what actually worked (and failed) in my projects.</p>
...
<pre><code class="language-bash"># Example workflow snippet
 ...
 git commit -m "feat: progress on Learning Docker from Scratch"</code></pre>
...
<p>Learning Docker from Scratch is a living topic—I will update this article as I learn more. If you are a student developer in Bangladesh building with Docker, connect with me on LinkedIn or explore more articles on kazinayeem.site. Keep building in public.</p>`,
});
