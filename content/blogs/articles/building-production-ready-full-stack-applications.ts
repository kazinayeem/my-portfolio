...
const post = createPost({
  ...
  description: "Building Production-Ready Full Stack Applications — a detailed guide by Mohammad Ali Nayeem, Software Engineering student at DIU and founder of Bornosoft. Real lessons from building projects in Bangladesh.",
  category: "Software Engineering",
  tags: ["Full Stack","Production","Best Practices"],
  keywords: ["Building Production-Ready Full Stack Applications","Mohammad Ali Nayeem","Bornosoft","Bangladesh","Software Engineering"],
  publishedAt: "2025-05-12",
  updatedAt: "2025-06-01",
  featured: false,
  popular: true,
  coverImageAlt: "Building Production-Ready Full Stack Applications - cover image by Mohammad Ali Nayeem",
  relatedSlugs: [],
  faqs: [
  {
  ...
  content: `<p>This article is part of my engineering journal at kazinayeem.site. I'm Mohammad Ali Nayeem, a Software Engineering student at Daffodil International University and founder of Bornosoft. Here I share practical lessons about building production-ready full stack applications—not textbook theory, but what actually worked (and failed) in my projects.</p>
...
<pre><code class="language-bash"># Example workflow snippet
 git checkout -b feature/building
 # implement → test → document
 git commit -m "feat: progress on Building Production-Ready Full Stack Applications"</code></pre>
...
<p>Building Production-Ready Full Stack Applications is a living topic—I will update this article as I learn more. If you are a student developer in Bangladesh building with Software Engineering, connect with me on LinkedIn or explore more articles on kazinayeem.site. Keep building in public.</p>`,
});
