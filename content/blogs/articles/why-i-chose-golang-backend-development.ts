...
const post = createPost({
  ...
  description: "Why I Chose Golang for Backend Development — a detailed guide by Mohammad Ali Nayeem, Software Engineering student at DIU and founder of Bornosoft. Real lessons from building projects in Bangladesh.",
  category: "Golang",
  tags: ["Golang","Backend","Architecture"],
  keywords: ["Why I Chose Golang for Backend Development","Mohammad Ali Nayeem","Bornosoft","Bangladesh","Golang"],
  publishedAt: "2024-12-20",
  updatedAt: "2025-06-01",
  featured: false,
  popular: false,
  coverImageAlt: "Why I Chose Golang for Backend Development - cover image by Mohammad Ali Nayeem",
  relatedSlugs: [],
  faqs: [
  {
  ...
  content: `<p>This article is part of my engineering journal at kazinayeem.site. I'm Mohammad Ali Nayeem, a Software Engineering student at Daffodil International University and founder of Bornosoft. Here I share practical lessons about why i chose golang for backend development—not textbook theory, but what actually worked (and failed) in my projects.</p>

<h2>Background & Motivation</h2>

<p>When I started exploring golang, resources were either too shallow or assumed years of experience. I wrote this guide for students and junior developers in Bangladesh who need a clear path from zero to confident.</p>
...
<pre><code class="language-bash"># Example workflow snippet
 git checkout -b feature/why
 # implement → test → document
 git commit -m "feat: progress on Why I Chose Golang for Backend Development"</code></pre>
...
<p>Why I Chose Golang for Backend Development is a living topic—I will update this article as I learn more. If you are a student developer in Bangladesh building with Golang, connect with me on LinkedIn or explore more articles on kazinayeem.site. Keep building in public.</p>`,
});
