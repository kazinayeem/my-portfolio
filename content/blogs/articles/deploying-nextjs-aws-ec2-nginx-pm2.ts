...
const post = createPost({
  ...
  title: "Deploying Next.js on AWS EC2 with Nginx & PM2",
  seoTitle: "Deploying Next.js on AWS EC2 with Nginx & PM2 | Mohammad Ali Nayeem",
  subtitle: "Practical insights from Mohammad Ali Nayeem, founder of Bornosoft",
  description: "Deploying Next.js on AWS EC2 with Nginx & PM2 — a detailed guide by Mohammad Ali Nayeem, Software Engineering student at DIU and founder of Bornosoft. Real lessons from building projects in Bangladesh.",
  category: "Next.js",
  tags: ["Next.js","AWS","Deployment"],
  keywords: ["Deploying Next.js on AWS EC2 with Nginx & PM2","Mohammad Ali Nayeem","Bornosoft","Bangladesh","Next.js"],
  publishedAt: "2024-12-10",
  updatedAt: "2025-06-01",
  featured: false,
  popular: true,
  coverImageAlt: "Deploying Next.js on AWS EC2 with Nginx & PM2 - cover image by Mohammad Ali Nayeem",
  relatedSlugs: [],
  faqs: [
  {
  ...
  content: `<p>This article is part of my engineering journal at kazinayeem.site. I'm Mohammad Ali Nayeem, a Software Engineering student at Daffodil International University and founder of Bornosoft. Here I share practical lessons about deploying next.js on aws ec2 with nginx & pm2—not textbook theory, but what actually worked (and failed) in my projects.</p>

<h2>Background & Motivation</h2>

<p>When I started exploring next.js, resources were either too shallow or assumed years of experience. I wrote this guide for students and junior developers in Bangladesh who need a clear path from zero to confident.</p>
...
<pre><code class="language-bash"># Example workflow snippet
 git checkout -b feature/deploying
 # implement → test → document
 git commit -m "feat: progress on Deploying Next.js on AWS EC2 with Nginx & PM2"</code></pre>
...
<p>Deploying Next.js on AWS EC2 with Nginx & PM2 is a living topic—I will update this article as I learn more. If you are a student developer in Bangladesh building with Next.js, connect with me on LinkedIn or explore more articles on kazinayeem.site. Keep building in public.</p>`,
});
