  ...
  faqs: [
      {
          ...
          "answer": "Master programming fundamentals, Git, and problem-solving before chasing every framework trend. Build one small project per month—even a CLI tool counts more than ten unfinished tutorials."
      },
      {
          "question": "How did you balance Bornosoft with coursework?",
          "answer": "I time-boxed startup work after assignments, reused course projects when topics aligned (networking, DB, OS), and said no to scope creep during exam weeks. Sustainable pace beats burnout heroics."
      },
      {
          "question": "Are internships accessible from DIU?",
          "answer": "Yes, through department notices, LinkedIn, local startups, and remote roles. A public portfolio with deployed projects and clear README files opens more doors than GPA alone."
      },
      {
          "question": "What electives or clubs helped most?",
          "answer": "Anything hands-on—robotics club, hackathons, open-source contributions, and DevOps labs where you touch Linux servers beat pure theory-only semesters for job readiness."
      }
  ],
  relatedSlugs: ["how-i-got-cursor-pro-free-as-diu-student","ai-tools-every-student-developer-should-know","my-future-roadmap-ai-devops-cloud"],
});
