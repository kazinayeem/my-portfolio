...
const post = createPost({
  ...
  description: "Creating a Portfolio That Ranks on Google — a detailed guide by Mohammad Ali Nayeem, Software Engineering student at DIU and founder of Bornosoft. Real lessons from building projects in Bangladesh.",
  category: "Tutorials",
  tags: ["SEO","Portfolio","Next.js"],
  keywords: ["Creating a Portfolio That Ranks on Google","Mohammad Ali Nayeem","Bornosoft","Bangladesh","Tutorials"],
  publishedAt: "2025-01-15",
  updatedAt: "2025-06-01",
  featured: false,
  popular: true,
  coverImageAlt: "Creating a Portfolio That Ranks on Google - cover image by Mohammad Ali Nayeem",
  relatedSlugs: [],
  faqs: [
  {
  ...
  content: `<p>This article is part of my engineering journal at kazinayeem.site. I'm Mohammad Ali Nayeem, a Software Engineering student at Daffodil International University and founder of Bornosoft. Here I share practical lessons about creating a portfolio that ranks on google—not textbook theory, but what actually worked (and failed) in my projects.</p>

<h2>Background & Motivation</h2>

<p>When I started exploring tutorials, resources were either too shallow or assumed years of experience. I wrote this guide for students and junior developers in Bangladesh who need a clear path from zero to confident.</p>
...
<pre><code class="language-bash"># Example workflow snippet
 git checkout -b feature/creating
 # implement → test → document
 git commit -m "feat: progress on Creating a Portfolio That Ranks on Google"</code></pre>
...
<p>Creating a Portfolio That Ranks on Google is a living topic—I will update this article as I learn more. If you are a student developer in Bangladesh building with Tutorials, connect with me on LinkedIn or explore more articles on kazinayeem.site. Keep building in public.</p>`,
});
