...
const post = createPost({
  ...
  title: "My Future Roadmap: AI + DevOps + Cloud",
  seoTitle: "My Future Roadmap: AI + DevOps + Cloud | Mohammad Ali Nayeem",
  subtitle: "Practical insights from Mohammad Ali Nayeem, founder of Bornosoft",
  description: "My Future Roadmap: AI + DevOps + Cloud — a detailed guide by Mohammad Ali Nayeem, Software Engineering student at DIU and founder of Bornosoft. Real lessons from building projects in Bangladesh.",
  category: "Cloud Computing",
  tags: ["Roadmap","AI","DevOps","Cloud"],
  keywords: ["My Future Roadmap: AI + DevOps + Cloud","Mohammad Ali Nayeem","Bornosoft","Bangladesh","Cloud Computing"],
  publishedAt: "2025-05-25",
  updatedAt: "2025-06-01",
  featured: false,
  popular: true,
  coverImageAlt: "My Future Roadmap: AI + DevOps + Cloud - cover image by Mohammad Ali Nayeem",
  relatedSlugs: [],
  faqs: [
  {
  ...
  content: `<p>This article is part of my engineering journal at kazinayeem.site. I'm Mohammad Ali Nayeem, a Software Engineering student at Daffodil International University and founder of Bornosoft. Here I share practical lessons about my future roadmap: ai + devops + cloud—not textbook theory, but what actually worked (and failed) in my projects.</p>

<h2>Background & Motivation</h2>

<p>When I started exploring cloud computing, resources were either too shallow or assumed years of experience. I wrote this guide for students and junior developers in Bangladesh who need a clear path from zero to confident.</p>
...
<pre><code class="language-bash"># Example workflow snippet
 ...
 git commit -m "feat: progress on My Future Roadmap: AI + DevOps + Cloud"</code></pre>
...
<p>My Future Roadmap: AI + DevOps + Cloud is a living topic—I will update this article as I learn more. If you are a student developer in Bangladesh building with Cloud Computing, connect with me on LinkedIn or explore more articles on kazinayeem.site. Keep building in public.</p>`,
});
