...
const post = createPost({
  ...
  description: "My DevOps Roadmap as a Software Engineering Student — a detailed guide by Mohammad Ali Nayeem, Software Engineering student at DIU and founder of Bornosoft. Real lessons from building projects in Bangladesh.",
  category: "DevOps",
  tags: ["DevOps","Roadmap","Student"],
  keywords: ["My DevOps Roadmap as a Software Engineering Student","Mohammad Ali Nayeem","Bornosoft","Bangladesh","DevOps"],
  publishedAt: "2024-11-05",
  updatedAt: "2025-06-01",
  featured: false,
  popular: true,
  coverImageAlt: "My DevOps Roadmap as a Software Engineering Student - cover image by Mohammad Ali Nayeem",
  relatedSlugs: [],
  faqs: [
  {
  ...
  content: `<p>This article is part of my engineering journal at kazinayeem.site. I'm Mohammad Ali Nayeem, a Software Engineering student at Daffodil International University and founder of Bornosoft. Here I share practical lessons about my devops roadmap as a software engineering student—not textbook theory, but what actually worked (and failed) in my projects.</p>

<h2>Background & Motivation</h2>

<p>When I started exploring devops, resources were either too shallow or assumed years of experience. I wrote this guide for students and junior developers in Bangladesh who need a clear path from zero to confident.</p>
...
<pre><code class="language-bash"># Example workflow snippet
 ...
 git commit -m "feat: progress on My DevOps Roadmap as a Software Engineering Student"</code></pre>
...
<p>My DevOps Roadmap as a Software Engineering Student is a living topic—I will update this article as I learn more. If you are a student developer in Bangladesh building with DevOps, connect with me on LinkedIn or explore more articles on kazinayeem.site. Keep building in public.</p>`,
});
