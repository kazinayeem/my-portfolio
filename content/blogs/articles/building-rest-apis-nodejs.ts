...
const post = createPost({
  ...
  description: "Building REST APIs with Node.js — a detailed guide by Mohammad Ali Nayeem, Software Engineering student at DIU and founder of Bornosoft. Real lessons from building projects in Bangladesh.",
  category: "Node.js",
  tags: ["Node.js","REST API","Backend"],
  keywords: ["Building REST APIs with Node.js","Mohammad Ali Nayeem","Bornosoft","Bangladesh","Node.js"],
  publishedAt: "2025-03-12",
  updatedAt: "2025-06-01",
  featured: false,
  popular: true,
  coverImageAlt: "Building REST APIs with Node.js - cover image by Mohammad Ali Nayeem",
  relatedSlugs: [],
  faqs: [
  {
  ...
  content: `<p>This article is part of my engineering journal at kazinayeem.site. I'm Mohammad Ali Nayeem, a Software Engineering student at Daffodil International University and founder of Bornosoft. Here I share practical lessons about building rest apis with node.js—not textbook theory, but what actually worked (and failed) in my projects.</p>

<h2>Background & Motivation</h2>

<p>When I started exploring node.js, resources were either too shallow or assumed years of experience. I wrote this guide for students and junior developers in Bangladesh who need a clear path from zero to confident.</p>
...
<pre><code class="language-bash"># Example workflow snippet
 ...
 git commit -m "feat: progress on Building REST APIs with Node.js"</code></pre>
...
<p>Building REST APIs with Node.js is a living topic—I will update this article as I learn more. If you are a student developer in Bangladesh building with Node.js, connect with me on LinkedIn or explore more articles on kazinayeem.site. Keep building in public.</p>`,
});
