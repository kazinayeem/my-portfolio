...
const post = createPost({
  ...
  description: "Terraform Basics for Beginners — a detailed guide by Mohammad Ali Nayeem, Software Engineering student at DIU and founder of Bornosoft. Real lessons from building projects in Bangladesh.",
  category: "Terraform",
  tags: ["Terraform","IaC","AWS"],
  keywords: ["Terraform Basics for Beginners","Mohammad Ali Nayeem","Bornosoft","Bangladesh","Terraform"],
  publishedAt: "2025-05-01",
  updatedAt: "2025-06-01",
  featured: false,
  popular: false,
  coverImageAlt: "Terraform Basics for Beginners - cover image by Mohammad Ali Nayeem",
  relatedSlugs: [],
  faqs: [
  {
  ...
  content: `<p>This article is part of my engineering journal at kazinayeem.site. I'm Mohammad Ali Nayeem, a Software Engineering student at Daffodil International University and founder of Bornosoft. Here I share practical lessons about terraform basics for beginners—not textbook theory, but what actually worked (and failed) in my projects.</p>

<h2>Background & Motivation</h2>

<p>When I started exploring terraform, resources were either too shallow or assumed years of experience. I wrote this guide for students and junior developers in Bangladesh who need a clear path from zero to confident.</p>
...
<pre><code class="language-bash"># Example workflow snippet
 ...
 git commit -m "feat: progress on Terraform Basics for Beginners"</code></pre>
...
<p>Terraform Basics for Beginners is a living topic—I will update this article as I learn more. If you are a student developer in Bangladesh building with Terraform, connect with me on LinkedIn or explore more articles on kazinayeem.site. Keep building in public.</p>`,
});
