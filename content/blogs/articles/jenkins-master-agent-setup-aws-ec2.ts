...
const post = createPost({
  ...
  title: "Building a Jenkins Master-Agent Setup on AWS EC2",
  seoTitle: "Building a Jenkins Master-Agent Setup on AWS EC2 | Mohammad Ali Nayeem",
  subtitle: "Practical insights from Mohammad Ali Nayeem, founder of Bornosoft",
  description: "Building a Jenkins Master-Agent Setup on AWS EC2 — a detailed guide by Mohammad Ali Nayeem, Software Engineering student at DIU and founder of Bornosoft. Real lessons from building projects in Bangladesh.",
  category: "Jenkins",
  tags: ["Jenkins","AWS","CI/CD"],
  keywords: ["Building a Jenkins Master-Agent Setup on AWS EC2","Mohammad Ali Nayeem","Bornosoft","Bangladesh","Jenkins"],
  publishedAt: "2024-10-25",
  updatedAt: "2025-06-01",
  featured: false,
  popular: false,
  coverImageAlt: "Building a Jenkins Master-Agent Setup on AWS EC2 - cover image by Mohammad Ali Nayeem",
  relatedSlugs: [],
  faqs: [
  {
  ...
  content: `<p>This article is part of my engineering journal at kazinayeem.site. I'm Mohammad Ali Nayeem, a Software Engineering student at Daffodil International University and founder of Bornosoft. Here I share practical lessons about building a jenkins master-agent setup on aws ec2—not textbook theory, but what actually worked (and failed) in my projects.</p>

<h2>Background & Motivation</h2>

<p>When I started exploring jenkins, resources were either too shallow or assumed years of experience. I wrote this guide for students and junior developers in Bangladesh who need a clear path from zero to confident.</p>
...
<pre><code class="language-bash"># Example workflow snippet
 git checkout -b feature/jenkins
 # implement → test → document
 git commit -m "feat: progress on Building a Jenkins Master-Agent Setup on AWS EC2"</code></pre>
...
<p>Building a Jenkins Master-Agent Setup on AWS EC2 is a living topic—I will update this article as I learn more. If you are a student developer in Bangladesh building with Jenkins, connect with me on LinkedIn or explore more articles on kazinayeem.site. Keep building in public.</p>`,
});
