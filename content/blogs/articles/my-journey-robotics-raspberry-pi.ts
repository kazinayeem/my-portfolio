...
const post = createPost({
  ...
  description: "My Journey into Robotics with Raspberry Pi — a detailed guide by Mohammad Ali Nayeem, Software Engineering student at DIU and founder of Bornosoft. Real lessons from building projects in Bangladesh.",
  category: "Raspberry Pi",
  tags: ["Robotics","Raspberry Pi","IoT"],
  keywords: ["My Journey into Robotics with Raspberry Pi","Mohammad Ali Nayeem","Bornosoft","Bangladesh","Raspberry Pi"],
  publishedAt: "2025-01-28",
  updatedAt: "2025-06-01",
  featured: false,
  popular: false,
  coverImageAlt: "My Journey into Robotics with Raspberry Pi - cover image by Mohammad Ali Nayeem",
  relatedSlugs: [],
  faqs: [
  {
  ...
  content: `<p>This article is part of my engineering journal at kazinayeem.site. I'm Mohammad Ali Nayeem, a Software Engineering student at Daffodil International University and founder of Bornosoft. Here I share practical lessons about my journey into robotics with raspberry pi—not textbook theory, but what actually worked (and failed) in my projects.</p>

<h2>Background & Motivation</h2>

<p>When I started exploring raspberry pi, resources were either too shallow or assumed years of experience. I wrote this guide for students and junior developers in Bangladesh who need a clear path from zero to confident.</p>
...
<pre><code class="language-bash"># Example workflow snippet
 ...
 git commit -m "feat: progress on My Journey into Robotics with Raspberry Pi"</code></pre>
...
<p>My Journey into Robotics with Raspberry Pi is a living topic—I will update this article as I learn more. If you are a student developer in Bangladesh building with Raspberry Pi, connect with me on LinkedIn or explore more articles on kazinayeem.site. Keep building in public.</p>`,
});
