...
const post = createPost({
  ...
  description: "AI Tools Every Student Developer Should Know — a detailed guide by Mohammad Ali Nayeem, Software Engineering student at DIU and founder of Bornosoft. Real lessons from building projects in Bangladesh.",
  category: "Artificial Intelligence",
  tags: ["AI Tools","Student","Productivity"],
  keywords: ["AI Tools Every Student Developer Should Know","Mohammad Ali Nayeem","Bornosoft","Bangladesh","Artificial Intelligence"],
  publishedAt: "2025-03-22",
  updatedAt: "2025-06-01",
  featured: false,
  popular: true,
  coverImageAlt: "AI Tools Every Student Developer Should Know - cover image by Mohammad Ali Nayeem",
  relatedSlugs: [],
  faqs: [
  {
  ...
  content: `<p>This article is part of my engineering journal at kazinayeem.site. I'm Mohammad Ali Nayeem, a Software Engineering student at Daffodil International University and founder of Bornosoft. Here I share practical lessons about ai tools every student developer should know—not textbook theory, but what actually worked (and failed) in my projects.</p>

<h2>Background & Motivation</h2>

<p>When I started exploring artificial intelligence, resources were either too shallow or assumed years of experience. I wrote this guide for students and junior developers in Bangladesh who need a clear path from zero to confident.</p>
...
<pre><code class="language-bash"># Example workflow snippet
 ...
 git commit -m "feat: progress on AI Tools Every Student Developer Should Know"</code></pre>
...
<p>AI Tools Every Student Developer Should Know is a living topic—I will update this article as I learn more. If you are a student developer in Bangladesh building with Artificial Intelligence, connect with me on LinkedIn or explore more articles on kazinayeem.site. Keep building in public.</p>`,
});
